...
:: "../battlesnake/battlesnake.exe" play -W 11 -H 11 --name AFK --url https://battlesnakeaiaaifg.kasperdelaxson.repl.co/ --name Adam --url https://battlesnake.up.railway.app/ --name CoreyjaHoveringHobs --url https://battlesnake-rs.fly.dev/hovering-hobbs --name CoreyjaDeviousDevin --url https://battlesnake-rs.fly.dev/devious-devin 1> out.txt 2>&1
